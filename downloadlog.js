...
var file ="data:text/csv;charset=utf-8,";
	    //var file = "data:text/plain;charset=utf-16,";
   //var file = "data:text/plain;base64,";
...
function download(e){ bugout.downloadLog();}



document.getElementById('log').addEventListener('click', logvisittype);
document.getElementById('log1').addEventListener('click', logvisittype1);
document.getElementById('log2').addEventListener('click', logvisittype2);
document.getElementById('log3').addEventListener('click', logvisittype3);
document.getElementById('log4').addEventListener('click', logvisittype4);
document.getElementById('log5').addEventListener('click', logvisittype6);
